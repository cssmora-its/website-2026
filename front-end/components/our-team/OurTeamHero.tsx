    ...
    >
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-20 w-full pt-32 md:pt-28 pb-16 md:pb-20 text-center">
        <div className={`text-white max-w-3xl mx-auto ${poppins.className}`}>
          ...
          <h1 className={`text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight mb-6 drop-shadow-lg animate-fade-in-up ${notoSerif.className}`} style={{ animationDelay: '0.3s', opacity: 0 }}>
            Our <span className="text-[#a8f070]">Team</span>
          </h1>

          <p className="text-base md:text-lg text-white/90 leading-relaxed max-w-2xl mx-auto mb-8 drop-shadow animate-fade-in-up" style={{ animationDelay: '0.6s', opacity: 0 }}>
